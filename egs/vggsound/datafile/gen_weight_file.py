...
parser.add_argument("--dataset", type=str, default="vgg", help="training optimizer", choices=["audioset", "vgg"])
parser.add_argument("--label_indices_path", type=str, default="./class_labels_indices_vgg.csv", help="the label vocabulary file.")
parser.add_argument("--datafile_path", type=str, default='./train_vgg.json', help="the path of data json file")
...
if __name__ == '__main__':
    ...
    num_class = 527 if args.dataset == 'audioset' else 309
