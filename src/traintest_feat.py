...
def train(audio_model, train_loader, test_loader, args):
    ...
    while epoch < args.n_epochs + 1:
        ...
        for i, (audio_input, labels) in enumerate(train_loader):
            ...
            seen_sample = global_step * int(args.batch_size / 10)
            if seen_sample <= 1000 and seen_sample % 50 == 0 and args.warmup == True:
                warm_lr = (seen_sample / 1000) * args.lr
